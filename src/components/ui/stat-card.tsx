  ...
  return (
    <div className="glass-panel p-5 rounded-xl transition-all duration-200 hover:shadow-md flex flex-col justify-between">
      <div className="flex items-center justify-between">
        ...
        {Icon && (
          <div className="p-2.5 bg-[#ECF4E8] rounded-xl text-[#14532D] border border-[#ABE7B2] shadow-2xs">
            <Icon className="w-4 h-4 text-[#14532D]" />
          </div>
        )}
      </div>
          ...
          <div className="flex items-center gap-1">
            <span
              className={`inline-flex items-center px-2 py-0.5 rounded-md text-[11px] font-bold ${
                isPositive
                  ? "bg-[#CBF3BB] text-[#14532D] border border-[#ABE7B2]"
